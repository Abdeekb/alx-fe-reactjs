...
function App() {
  ...
  // 2. Define userData to be passed through the Context
  const userData = { name: "Alice", age: "25", bio: "Loves hiking and photography" };

  return (
    <UserContext.Provider value={userData}> {/* 3. Provide Context with userData */}
      <Header />
      <MainContent />
      <Footer />
      <UserProfile /> {/* UserProfile now consumes data from UserContext */}
      <div>
